      ...
      describe "redirects" do
        ...
        describe "create" do
          ...
          context "duplicate" do
            before(:each) { FactoryGirl.create(:redirect, :title => "UniqueTitle") }
        ...
        describe "edit" do
          before(:each) { FactoryGirl.create(:redirect, :title => "A title") }
        ...
        describe "destroy" do
          before(:each) { FactoryGirl.create(:redirect, :title => "UniqueTitleOne") }
